...
public class Mailer {
    ...
    public void SendEmailOfNotification(User userDetails, String facility) {
        ...
        // change app password accordingly
        ...
        try {
            ...
            message.setFrom(new InternetAddress("aswinlakshmanan1998@gmail.com"));
    ...
    public static void main(String[] args) {
        ...
        User user = new User("Lakshmanan", "Aswin", "lakshmanan.aswin888@gmail.com");
        Mailer mailer = new Mailer();
        mailer.SendEmailOfNotification(user, "Swimming Pool");
    }
}